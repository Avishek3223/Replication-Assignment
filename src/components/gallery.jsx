...
function Gallery() {
  ...
  return (
    <div>
      <div
        className="relative max-w-[720px] rounded-[19px] p-3 h-[316px] bg-[#363C43] max1600:w-[600px] max1600:h-[37vh]"
        ...
        <div className="flex flex-col justify-around h-full">
          ...
          <div className="flex flex-col justify-between items-center">
            <div className="flex justify-between w-[85%]">
              <button
                className="bg-[#171717] text-white py-4 px-10 rounded-[20px] max1530:py-3"
              ...
              <div className="flex items-center space-x-4">
                ...
                />
                <button
                  className="flex gap-1 mr-3 bg-[#ffffff13] tracking-[1px] text-[#ecececea] p-4 px-5 rounded-full text-[12px] font-[800] text-center max1530:p-3"
                  style={{
                    boxShadow: `
                ...
                <button
                  className="text-white p-4 rounded-full max1530:p-3"
                  style={{
                    background:
          ...
          >
            {images.map((image, index) => (
              ...
              <img
                key={index}
                className="image-zoom rounded-[24px] w-[11rem] h-[11rem] flex-shrink-0 max1600:w-[9rem] max1600:h-[9rem]"
                src={image}
